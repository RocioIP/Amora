module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      textColor: {
        /* 'principal-1': 'rgba(153,102,117)', */
        'principal-1': 'rgba(150,110,143,255)',
        /* 'principal-2': '#d1c69f', */
        'principal-2': 'rgba(169,159,162,255)',
      },
      height: {
      ...
      backgroundColor: {
        ...
        /* 'principal-1': 'rgba(153,102,117)', */
        'principal-1': 'rgba(150,110,143,255)',
        /* 'principal-2-hover': 'rgba(216, 207, 175, 0.84)', */
        'principal-2-hover': 'rgba(169,159,162,255)',
      },
      boxShadow: {
